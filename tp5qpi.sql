...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'admin', '227af9354aef4e7d4050b1043d5be6b7', '123@163.com', '123', '', 'http://api.hardphp.com/uploads/images/20190322/41ef26c97b94a327562671abd56385a6.jpg', '1498276451', '127.0.0.1', '1553234296', '39.149.12.184', '1553234323', '1', '1');
...
-- Records of app
-- ----------------------------
INSERT INTO `app` VALUES ('1', 'ty9fd2848a039ab554', 'ec32286d0718118861afdbf6e401ee81', '管理员端', '', '1498276451', '127.0.0.1', '1521305444', '123.149.208.76', '1514962598', '1');
INSERT INTO `app` VALUES ('2', 'ty9fd2848a039abbbb', 'ec32286d0718118861afdbf6e401ee81', '淘宝客端', '', '1498276451', '127.0.0.1', '1521305444', '123.149.208.76', '1514962598', '1');
...
-- ----------------------------
INSERT INTO `auth_group` VALUES ('1', '超级管理员', '1', '44,45,41,43,42,39,40,1,38,7,2', '1552300913');
INSERT INTO `auth_group` VALUES ('2', '普通管理员', '1', '1,2', '1542787522');
...
-- ----------------------------
INSERT INTO `auth_rule` VALUES ('1', 'manage', '权限管理', '1', '1', '', '0', '0', 'component', '1547187800', '/manage', 'layout/Layout', '0', '0', '1', '');
INSERT INTO `auth_rule` VALUES ('2', 'manage/admin', '管理员列表', '1', '1', '', '1', '0', 'user', '1541666364', 'admin', 'manage/admin', '0', '0', '0', '');
INSERT INTO `auth_rule` VALUES ('7', 'manage/rules', '权限列表', '1', '1', '', '1', '0', 'lock', '1542353476', 'rules', 'manage/rules', '0', '0', '0', '');
INSERT INTO `auth_rule` VALUES ('38', 'manage/roles', '角色列表', '1', '1', '', '1', '0', 'list', '1542602805', 'roles', 'manage/roles', '0', '1', '1', '');
INSERT INTO `auth_rule` VALUES ('39', 'log', '日志管理', '1', '1', '', '0', '0', 'component', '1542602916', '/log', 'layout/Layout', '0', '0', '1', '');
INSERT INTO `auth_rule` VALUES ('40', 'log/log', '登陆日志', '1', '1', '', '39', '0', 'list', '1552301777', 'log', 'log/log', '0', '1', '1', '');
...
-- ----------------------------
INSERT INTO `login_log` VALUES ('1', '1', 'admin', '127.0.0.1', '1553234028', '超级管理员');
INSERT INTO `login_log` VALUES ('2', '1', 'admin', '127.0.0.1', '1553234296', '超级管理员');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '', 'ee8512502ab075a1ad969238ca83a15d', '', '12312333', '张三', '1', 'hardphp', 'http://api.hardphp.com/uploads/images/20190108/21b4a8aa748142cd506976ef0f7e1bbb.png', '0', '20210.00', '1989-10-10', '我要给你一个拥抱 给你一双温热手掌', '525225.00', '0', '0', '', '', '1515057952', '123.149.214.69', '', '0', '1553167717', '1', '74735600372', '0', '7');
...
-- ----------------------------
INSERT INTO `user_login_log` VALUES ('1', '6', null, '121.199.30.7', '1501656638');
INSERT INTO `user_login_log` VALUES ('2', '6', null, '121.199.30.7', '1501833739');
